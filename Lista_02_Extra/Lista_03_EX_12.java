...
public class Lista_03_EX_12 {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("%n%d%% dos apostadores fizeram entre 10 e 13 Acertos%n", porcentagem10a13);
        System.out.printf("%n%d%% dos apostadores fizeram menos de 10 Acertos%n", porcentagemMenor10);
